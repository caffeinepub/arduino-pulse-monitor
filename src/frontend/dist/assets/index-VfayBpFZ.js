...
const BluetoothOff = createLucideIcon("bluetooth-off", __iconNode$8);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */
const __iconNode$7 = [["path", { d: "m7 7 10 10-5 5V2l5 5L7 17", key: "1q5490" }]];
const Bluetooth = createLucideIcon("bluetooth", __iconNode$7);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const EXERCISES = [
  {
    name: "Jumping Jacks",
    description: "A full-body cardio exercise that raises your heart rate and improves circulation.",
    steps: [
  ...
  {
    name: "Push-ups",
    description: "Strengthens the chest, shoulders, and arms while gently elevating heart rate.",
    steps: [
  ...
  {
    name: "Squats",
    description: "Works the large leg muscles, boosting circulation and heart health.",
    steps: [
  ...
  {
    name: "Plank",
    description: "Builds core stability and endurance, supporting good posture and heart function.",
    steps: [
...
function useCountUp(target, duration = 400) {
  const [displayed, setDisplayed] = reactExports.useState(target);
...
function FadeIn({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `animate-fade-in ${className}`, "data-ocid": dataOcid, children });
}
...
function BpmSparkline({ history }) {
  ...
  const toX = (i) => padX + i / (history.length - 1) * (width - padX * 2);
  const toY = (v2) => padY + (maxVal - v2) / range * (height - padY * 2);
  const points = history.map((v2, i) => `${toX(i)},${toY(v2)}`).join(" ");
  const polyPath = `M ${history.map((v2, i) => `${toX(i)} ${toY(v2)}`).join(" L ")}`;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full mt-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-mono text-muted-foreground mb-2 text-center tracking-widest uppercase", children: "BPM History" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        ...
        role: "img",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "BPM history sparkline" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "bpm-area-gradient", x1: "0", y1: "0", x2: "0", y2: "1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "stop",
              {
                offset: "0%",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: areaPath, fill: "url(#bpm-area-gradient)" }),
          showHighLine && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "line",
            {
              x1: padX,
              y1: highY,
          ...
          showLowLine && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "line",
            {
              x1: padX,
              y1: lowY,
...
function App() {
  ...
  const [sensorState, setSensorState] = reactExports.useState("waiting");
  const [bpm, setBpm] = reactExports.useState(null);
  const [bpmHistory, setBpmHistory] = reactExports.useState([]);
  const [deviceName, setDeviceName] = reactExports.useState(null);
  const [expandedExercise, setExpandedExercise] = reactExports.useState(null);
  const [connectShake, setConnectShake] = reactExports.useState(false);
  const [scanDialogOpen, setScanDialogOpen] = reactExports.useState(false);
  const deviceRef = reactExports.useRef(null);
  const characteristicRef = reactExports.useRef(
    null
  );
  const sensorTimeoutRef = reactExports.useRef(null);
  const bufferRef = reactExports.useRef("");
  const lastAlertBpmRef = reactExports.useRef(null);
  ...
  const resetSensorTimeout = reactExports.useCallback(() => {
  ...
  const parseBpm = reactExports.useCallback(
    (chunk) => {
      ...
      for (let i = 0; i < lines.length - 1; i++) {
        ...
        if (!Number.isNaN(value) && value >= BPM_MIN && value <= BPM_MAX) {
          ...
          setBpmHistory((prev) => {
            ...
            return next.length > BPM_HISTORY_MAX ? next.slice(next.length - BPM_HISTORY_MAX) : next;
          });
          resetSensorTimeout();
          const wasAbnormal = lastAlertBpmRef.current !== null && (lastAlertBpmRef.current < ALERT_LOW || lastAlertBpmRef.current > ALERT_HIGH);
          const isAbnormal = value < ALERT_LOW || value > ALERT_HIGH;
          if (isAbnormal && !wasAbnormal) {
            ue.warning("Warning: Abnormal Pulse Rate Detected", {
              duration: 6e3,
  ...
  const handleDisconnect = reactExports.useCallback(() => {
    ...
    ue.error("Bluetooth device disconnected");
  }, []);
      ...
      reconnectTimeoutRef.current = setTimeout(async () => {
        try {
          ...
          if (rxChar) {
            ...
            setSensorState("waiting");
            ue.success(`Reconnected to ${device.name ?? "Arduino Module"}`);
          } else {
  ...
  const disconnect = reactExports.useCallback(() => {
    ...
    if ((_b2 = (_a2 = deviceRef.current) == null ? void 0 : _a2.gatt) == null ? void 0 : _b2.connected) {
      deviceRef.current.gatt.disconnect();
    }
    handleDisconnect();
    ue.success("Disconnected");
  }, [handleDisconnect]);
  const connect = reactExports.useCallback(async () => {
    ...
    try {
      ...
      if (rxChar) {
        ...
        setConnectionState("connected");
        setSensorState("waiting");
        ue.success(`Connected to ${device.name ?? "Arduino Module"}`);
      } else {
      ...
      if ((err == null ? void 0 : err.name) !== "NotFoundError") {
        ue.error(
          (err == null ? void 0 : err.message) ?? "Connection failed"
        );
  ...
  const isSensorActive = isConnected && sensorState === "connected" && bpm !== null;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-blob-crimson", "aria-hidden": "true" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-blob-blue", "aria-hidden": "true" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-grid", "aria-hidden": "true" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-vignette", "aria-hidden": "true" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: scanDialogOpen, onOpenChange: setScanDialogOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { "data-ocid": "scan.dialog", className: "max-w-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "font-display font-700 text-foreground flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bluetooth, { className: "w-5 h-5 text-primary" }),
          "Scan for Devices"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogDescription, { className: "text-muted-foreground leading-relaxed", children: [
          "Your browser will show a list of nearby Bluetooth devices. Select your",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: "HC-05 module" }),
          " ",
          "from the list to connect."
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg bg-muted/30 border border-border/50 px-4 py-3 text-sm text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-foreground mb-1", children: "Before connecting:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-1 list-disc list-inside", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Make sure your Arduino is powered on" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "HC-05 LED should be blinking (not solid)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Enable Bluetooth on your device" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Bluetooth, { className: "w-4 h-4 mr-2" }),
              "Start Scan"
            ]
          }
        )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "relative z-10 border-b border-border/50 bg-card/40 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-6 py-4 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "w-6 h-6 text-primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-700 text-lg tracking-tight text-foreground", children: "BP Recovery System" }),
          deviceName && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-mono", children: deviceName })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Badge,
          {
            ...
            variant: "outline",
            className: `text-xs font-mono px-2 py-0.5 gap-1.5 border ${isConnected ? "border-success/50 text-success bg-success/10" : "border-muted-foreground/30 text-muted-foreground"}`,
            children: [
              isConnected ? /* @__PURE__ */ jsxRuntimeExports.jsx(Bluetooth, { className: "w-3 h-3" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(BluetoothOff, { className: "w-3 h-3" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Badge,
          {
            ...
            variant: "outline",
            className: `text-xs font-mono px-2 py-0.5 gap-1.5 border ${isSensorActive ? "border-success/50 text-success bg-success/10" : "border-muted-foreground/30 text-muted-foreground"}`,
            children: [
              isSensorActive ? /* @__PURE__ */ jsxRuntimeExports.jsx(Wifi, { className: "w-3 h-3" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(WifiOff, { className: "w-3 h-3" }),
              "Sensor: ",
              isSensorActive ? "Connected" : "Not Connected"
            ]
          }
        )
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "relative z-10 flex-1 flex flex-col items-center px-6 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-2xl flex flex-col items-center", children: [
      !isWebBluetoothSupported && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        FadeIn,
        {
          className: "text-center max-w-md",
          "data-ocid": "display.error_state",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-20 h-20 rounded-full bg-destructive/10 border border-destructive/30 flex items-center justify-center mx-auto mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-10 h-10 text-destructive" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-700 text-2xl text-foreground mb-3", children: "Browser Not Supported" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground leading-relaxed", children: [
              ...
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: "Chrome on Android" }),
              " ",
              "or",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: "Chrome on desktop" }),
              "."
            ] })
          ]
        }
      ),
      isWebBluetoothSupported && !isConnected && /* @__PURE__ */ jsxRuntimeExports.jsxs(FadeIn, { className: "text-center", "data-ocid": "display.loading_state", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-32 h-32 mx-auto mb-8", children: [
          isConnecting && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full border border-primary/30 animate-ping" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-2 rounded-full border border-primary/50 animate-pulse" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `absolute inset-0 rounded-full border transition-colors duration-300 ${isConnecting ? "border-primary/30 bg-primary/5" : "border-border bg-muted/30"} flex items-center justify-center`,
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: isConnecting ? "animate-spin-slow" : "", children: isConnecting ? /* @__PURE__ */ jsxRuntimeExports.jsx(Bluetooth, { className: "w-12 h-12 text-primary" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(BluetoothOff, { className: "w-12 h-12 text-muted-foreground" }) })
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-700 text-3xl text-foreground mb-3", children: isConnecting ? "Connecting..." : "Connect to Bluetooth Module" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-10 max-w-sm mx-auto", children: isConnecting ? "Select your Arduino Bluetooth module from the list" : "Pair with your Arduino HC-05 / HC-06 to start monitoring pulse rate in real time." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            className: `bg-primary/90 hover:bg-primary text-primary-foreground px-10 py-4 text-lg font-display font-600 rounded-full shadow-glow transition-all duration-200 hover:shadow-glow-lg active:scale-95 ${connectShake ? "connect-shake" : ""}`,
            children: isConnecting ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner, { className: "w-5 h-5 mr-2" }),
              "Connecting..."
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Bluetooth, { className: "w-5 h-5 mr-2" }),
              "Scan & Connect"
            ] })
          }
        )
      ] }),
      isConnected && sensorState === "waiting" && /* @__PURE__ */ jsxRuntimeExports.jsxs(FadeIn, { className: "text-center", "data-ocid": "display.loading_state", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-32 h-32 mx-auto mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full border border-primary/20 animate-ping" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-4 rounded-full border border-primary/40 animate-pulse" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-12 h-12 text-primary/60" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-700 text-2xl text-foreground mb-2", children: "Waiting for sensor data..." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Place finger on the pulse sensor" })
      ] }),
      isConnected && sensorState === "disconnected" && /* @__PURE__ */ jsxRuntimeExports.jsxs(FadeIn, { className: "text-center", "data-ocid": "display.error_state", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-32 h-32 mx-auto mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full bg-destructive/10 border border-destructive/30" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-12 h-12 text-destructive/60" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-700 text-3xl text-foreground mb-3", children: "Pulse Sensor Not Connected" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-sm mx-auto", children: "No valid BPM data received. Check your pulse sensor wiring and place your finger firmly on the sensor." })
      ] }),
      isSensorActive && bpm !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        FadeIn,
        {
          className: "text-center w-full",
          "data-ocid": "display.bpm_panel",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-56 h-56 mx-auto mb-8 flex items-center justify-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full border border-primary/20 pulse-ring" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full border border-primary/15 pulse-ring-2" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 flex flex-col items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Heart,
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-600 text-2xl text-muted-foreground tracking-widest uppercase mt-1", children: "BPM" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 flex items-center justify-center gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: `text-xs font-mono px-3 py-1 rounded-full border ${bpm < ALERT_LOW ? "text-blue-400 border-blue-400/30 bg-blue-400/10" : bpm <= 100 ? "text-success border-success/30 bg-success/10" : "text-orange-400 border-orange-400/30 bg-orange-400/10"}`,
                children: bpm < ALERT_LOW ? "Below Normal" : bpm <= 100 ? "Normal Range" : "Elevated"
              }
            ) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: `mt-6 mx-auto max-w-sm rounded-xl border px-5 py-4 flex items-start gap-3 text-left transition-all duration-300 ${isHighPulse ? "border-orange-400/30 bg-orange-400/10 opacity-100 translate-y-0" : isLowPulse ? "border-blue-400/30 bg-blue-400/10 opacity-100 translate-y-0" : "border-transparent opacity-0 pointer-events-none -translate-y-2"}`,
                "data-ocid": "alert.suggestion_panel",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    TriangleAlert,
                    {
                      className: `w-5 h-5 mt-0.5 shrink-0 ${isHighPulse ? "text-orange-400" : "text-blue-400"}`
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      className: `text-sm leading-relaxed ${isHighPulse ? "text-orange-300" : "text-blue-300"}`,
                      children: isHighPulse ? "Take slow deep breaths: inhale 4s, hold 4s, exhale 6s. Try a seated forward fold yoga pose to calm your heart rate." : "Try light movement: walk in place for 1 minute, or do 10 gentle jumping jacks to bring your pulse up."
                    }
                  )
                ]
              }
            ),
            !isAbnormalPulse && bpmHistory.length >= 2 && /* @__PURE__ */ jsxRuntimeExports.jsx(BpmSparkline, { history: bpmHistory }),
            isAbnormalPulse && bpmHistory.length >= 2 && /* @__PURE__ */ jsxRuntimeExports.jsx(BpmSparkline, { history: bpmHistory })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: `mt-12 transition-all duration-300 ${isConnected ? "opacity-100 translate-y-0" : "opacity-0 pointer-events-none translate-y-4"}`,
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(BluetoothOff, { className: "w-4 h-4 mr-2" }),
                "Disconnect"
              ]
            }
          )
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-700 text-xl text-foreground tracking-tight", children: "Heart Health Exercises" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-px bg-border/50" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: EXERCISES.map((exercise, idx) => {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-600 text-foreground", children: exercise.name }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: exercise.description })
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionPanel, { open: isOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 pb-5 border-t border-border/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "mt-4 space-y-2", children: exercise.steps.map((step, stepIdx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "li",
                      {
                        className: "flex items-start gap-3",
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "shrink-0 w-6 h-6 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-mono font-600 flex items-center justify-center mt-0.5", children: stepIdx + 1 }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: step })
                        ]
                      },
                      step.slice(0, 20)
                    )) }) }) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "relative z-10 border-t border-border/30 py-4 text-center mt-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground/60", children: [
      "© ",
